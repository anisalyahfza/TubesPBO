...
public class Transaksi extends javax.swing.JFrame {
    ...
    class transaksi extends Transaksi{
        ...
        String nama_pelangggan, tanggal, nama_masakan;

        public transaksi() {
            this.nama_pelangggan = text_nama_pelanggan.getText();
    ...
    private void btn_inputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_inputActionPerformed
        ...
        try {
            ...
            stat.setInt(1, 0);
            stat.setString(2, u.nama_pelangggan);
            ...
            int pilihan = JOptionPane.showConfirmDialog(null,
                    "Tanggal: "+u.tanggal+
                    "\nNama Pelanggan: "+u.nama_pelangggan+
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        ...
        try {
            ...
            this.stat = k.getCon().prepareStatement("update transaksi set nama_pelangggan=?,"
                    + "id_masakan=?,tanggal=?,nama_masakan=?,harga=?,jumlah_beli=?,total_bayar=? "
                    + "where id_transaksi=?");
            
            stat.setString(1, u.nama_pelangggan);
